...
public class LoadingStateIdle extends LoadingState {

	private static String ANIM_FILE = "/sprites/player/kirby_normal/idle.anim";

	public LoadingStateIdle(GameStateManager gsm) {
		super(gsm);
	}
